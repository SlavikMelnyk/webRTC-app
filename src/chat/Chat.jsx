...
const Chat = ({ name, messages, sendMessage }) => {
    ...
    return (
        <div className='absolute z-10 top-[10px] right-[10px] bg-white text-center rounded-md w-[300px] h-fit' style={{ maxHeight: 'calc(100% - 86px)', display: 'flex', flexDirection: 'column' }}>
